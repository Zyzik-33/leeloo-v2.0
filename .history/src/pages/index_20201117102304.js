...
const IndexPage = ({data}) => (
  <>
    ...
    <ImageWrapper src={data.file.childImageSharp.fluid.src} srcSet={data.file.childImageSharp.fluid.srcSet} sizes={data.file.childImageSharp.fluid.sizes} alt='leeloo' />
  </>
)
...
export const query = graphql`
  {
    file(name: {eq: "header_img"}) {
      childImageSharp {
        fluid(maxWidth: 800, maxHeight: 1200, quality: 10) {
           src
           srcSet
           sizes
        }
